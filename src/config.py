...
STANDARD_CUT_LENGTHS_M = (100, 500, 1000)
MIN_SENSOR_READINGS_PER_DAY = 20
WEAK_BATTERY_VOLTAGE_MV = 3800.0
WEAK_SIGNAL_STRENGTH_DBM = -80.0
STALE_DATA_WARNING_DAYS = 7
DEFAULT_DEMO_PASSWORD = "12345"
